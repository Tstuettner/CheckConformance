Imports annotation_replies.DynaPDF
      ...
      Try
         ...
         pdf.CreateNewPDF(Nothing) ' We do not create a PDF file in this example
            ...
            pdf.Append()
               ...
               reply = pdf.SetAnnotMigrationState(annot, TAnnotState.asCreateReply, "Harry")
               pdf.SetAnnotString(reply, TAnnotString.asContent, "This is a reply!")

               reply = pdf.SetAnnotMigrationState(reply, TAnnotState.asCreateReply, "Jim")
               pdf.SetAnnotString(reply, TAnnotString.asContent, "This is a reply to a reply!")
            pdf.EndPage()
