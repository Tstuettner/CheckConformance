...
Module Module1
   ...
   Sub Main()
      Try
         Dim root As IntPtr, grp As IntPtr
         ...
         pdf.CreateNewPDF(Nothing) ' We do not create a PDF file in this example
            ...
            grp = pdf.AddLayerToDisplTree(root, -1, Nothing)
            pdf.AddLayerToDisplTree(grp, oc2, Nothing)
            pdf.AddLayerToDisplTree(grp, oc3, Nothing)
