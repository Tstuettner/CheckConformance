...
Imports System.Text
Imports render_page_ex.DynaPDF
...
Public Class Form1
   ...
   Private m_DestX As Integer
   Private m_DestY As Integer
   ...
   Private Sub Form1_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
         ...
         ExtTextOut(m_DC, 0, 0, ETO_OPAQUE, r, IntPtr.Zero, 0, IntPtr.Zero)
         If m_Update Then
            If IsNothing(m_RenderThread) Then StartRenderThread()
   ...
   Private Sub Form1_SizeChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.SizeChanged
      ...
      SetBkColor(m_DC, APP_BACK_COLOR)
      ExtTextOut(m_DC, 0, 0, ETO_OPAQUE, r, IntPtr.Zero, 0, IntPtr.Zero)
      If Not IsNothing(m_PDF) AndAlso m_PDF.ResizeBitmap(m_RAS, m_DC, m_ImgW, m_ImgH) Then
         m_AdjWindow = True
         RenderCurrPage()
      End If
   End Sub
   ...
   Private Sub RenderCurrPage()
      ...
      If m_CurrPage > 0 Then
         ...
         m_PDF.CalcPagePixelSize(m_CurrPageObj, TPDFPageScale.psFitBest, 1.0F, m_ScreenW - m_BorderX, m_ScreenH - m_BorderY, m_RasImage.Flags, m_ImgW, m_ImgH)
         If m_AdjWindow Then
            Dim w As Integer = m_ImgW + m_BorderX
            Dim h As Integer = m_ImgH + m_BorderY
            If ClientRectangle.Width - APP_CLIENT_BORDER <> m_ImgW Or ClientRectangle.Height - APP_CLIENT_BORDER <> m_ImgH Then
               m_AdjWindow = False
   ...
   Private Sub RenderPageFunc()
      m_PDF.RenderPageEx(m_DC, m_DestX, m_DestY, m_CurrPageObj, m_RAS, m_RasImage)
      m_Update = False
   End Sub
